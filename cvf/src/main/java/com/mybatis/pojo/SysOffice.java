...
public class SysOffice {
	...
	public String toString() {
		return "SysOffice [id=" + id + ", parent_id=" + parent_id
				+ ", parent_ids=" + parent_ids + ", name=" + name + ", sort="
				+ sort + ", area_id=" + area_id + ", code=" + code + ", type="
				+ type + ", grade=" + grade + ", address=" + address
				+ ", zip_code=" + zip_code + ", master=" + master + ", phone="
				+ phone + ", fax=" + fax + ", email=" + email + ", USEABLE="
				+ USEABLE + ", PRIMARY_PERSON=" + PRIMARY_PERSON
				+ ", DEPUTY_PERSON=" + DEPUTY_PERSON + ", create_by="
