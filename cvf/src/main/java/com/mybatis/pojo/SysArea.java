...
public class SysArea {
	...
	public String toString() {
		return "SysArea [id=" + id + ", parent_id=" + parent_id + ", code="
				+ code + ", name=" + name + ", simple_name=" + simple_name
				+ ", zip_code=" + zip_code + ", area_number=" + area_number
				+ ", level=" + level + ", path_ids=" + path_ids
				+ ", path_names=" + path_names + ", remarks=" + remarks
				+ ", del_flag=" + del_flag + ", create_date=" + create_date
				+ ", create_by=" + create_by + ", update_date=" + update_date
				+ ", update_by=" + update_by + ", parent_ids=" + parent_ids
				+ ", type=" + type + ", sort=" + sort + ", shipping_group="
				+ shipping_group + ", store_id=" + store_id + "]";
	}
