...
public class POIReadExcelUtils {
	...
	public static String excelWriteToHtml(String sourcePath){
		...
		try {
			...
			String excelHtml = POIReadExcelUtils.readExcelToHtml(fis, true);
			return excelHtml;
	...
	public static String getExcelInfo(Workbook wb, boolean isWithStyle){
		...
		for (int rowNum = sheet.getFirstRowNum(); rowNum <= lastRowNum; rowNum ++) {
			...
			int lastColNum = POIReadExcelUtils.getColsOfTable(sheet)[0];
			int rowHeight = POIReadExcelUtils.getColsOfTable(sheet)[1];
