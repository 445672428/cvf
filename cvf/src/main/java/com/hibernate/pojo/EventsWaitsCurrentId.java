...
/**
 * EventsWaitsCurrentId entity. @author MyEclipse Persistence Tools
 */

public class EventsWaitsCurrentId implements java.io.Serializable {
	...
	/** default constructor */
	public EventsWaitsCurrentId() {
	}

	/** minimal constructor */
	public EventsWaitsCurrentId(Integer threadId, Long eventId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EventsWaitsCurrentId))
			return false;
		EventsWaitsCurrentId castOther = (EventsWaitsCurrentId) other;
