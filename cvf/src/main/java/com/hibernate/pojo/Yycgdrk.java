...
/**
 * Yycgdrk entity. @author MyEclipse Persistence Tools
 */

public class Yycgdrk implements java.io.Serializable {
	...
	/** minimal constructor */
	public Yycgdrk(String id, String yycgdid, String ypxxid, BigDecimal rkl,
			Double rkje, String rkdh, String ypph, Double ypyxq,
			Timestamp rktime) {
		this.id = id;
	...
	/** full constructor */
	public Yycgdrk(String id, String yycgdid, String ypxxid, String vchar1,
			String vchar2, String vchar3, String vchar4, String vchar5,
			BigDecimal rkl, Double rkje, String rkdh, String ypph,
			Double ypyxq, Timestamp rktime, String cgzt) {
		this.id = id;
		this.yycgdid = yycgdid;
		this.ypxxid = ypxxid;
		this.vchar1 = vchar1;
