...
/**
 * EventsWaitsSummaryGlobalByEventNameId entity. @author MyEclipse Persistence
 * Tools
 */

public class EventsWaitsSummaryGlobalByEventNameId implements
	...
	/** default constructor */
	public EventsWaitsSummaryGlobalByEventNameId() {
	}

	/** full constructor */
	public EventsWaitsSummaryGlobalByEventNameId(String eventName,
			Long countStar, Long sumTimerWait, Long minTimerWait,
			Long avgTimerWait, Long maxTimerWait) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EventsWaitsSummaryGlobalByEventNameId))
			return false;
		EventsWaitsSummaryGlobalByEventNameId castOther = (EventsWaitsSummaryGlobalByEventNameId) other;
