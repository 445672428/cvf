...
public class Host implements java.io.Serializable {
	...
	/** full constructor */
	public Host(HostId id, String selectPriv, String insertPriv,
			String updatePriv, String deletePriv, String createPriv,
			String dropPriv, String grantPriv, String referencesPriv,
			String indexPriv, String alterPriv, String createTmpTablePriv,
			String lockTablesPriv, String createViewPriv, String showViewPriv,
			String createRoutinePriv, String alterRoutinePriv,
			String executePriv, String triggerPriv) {
		this.id = id;
