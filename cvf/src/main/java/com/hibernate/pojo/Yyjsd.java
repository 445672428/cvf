...
/**
 * Yyjsd entity. @author MyEclipse Persistence Tools
 */

public class Yyjsd implements java.io.Serializable {
	...
	/** minimal constructor */
	public Yyjsd(String id, String bm, String mc, String useryyid,
			Timestamp cjtime, Timestamp tjtime) {
		this.id = id;
		this.bm = bm;
		this.mc = mc;
	...
	/** full constructor */
	public Yyjsd(String id, String bm, String mc, String useryyid, String lxr,
