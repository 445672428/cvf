...
/**
 * EventsWaitsHistoryId entity. @author MyEclipse Persistence Tools
 */

public class EventsWaitsHistoryId implements java.io.Serializable {
	...
	/** default constructor */
	public EventsWaitsHistoryId() {
	}

	/** minimal constructor */
	public EventsWaitsHistoryId(Integer threadId, Long eventId,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof EventsWaitsHistoryId))
			return false;
		EventsWaitsHistoryId castOther = (EventsWaitsHistoryId) other;
