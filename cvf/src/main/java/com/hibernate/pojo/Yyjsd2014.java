...
/**
 * Yyjsd2014 entity. @author MyEclipse Persistence Tools
 */

public class Yyjsd2014 implements java.io.Serializable {
	...
	/** minimal constructor */
	public Yyjsd2014(String id, String bm, String mc, String useryyid,
	...
	public Yyjsd2014(String id, String bm, String mc, String useryyid,
			...
			Timestamp tjtime, Timestamp xgtime, String bz, String zt,
			String vchar1, String vchar2, String vchar3) {
		this.id = id;
		this.bm = bm;
		this.mc = mc;
		this.useryyid = useryyid;
