...
/**
 * Yyjsdmx2014 entity. @author MyEclipse Persistence Tools
 */

public class Yyjsdmx2014 implements java.io.Serializable {
	...
	/** minimal constructor */
	public Yyjsdmx2014(String id, String yyjsdid, String ypxxid,
			String yycgdid, BigDecimal jsl, Double jsje, String jszt) {
		this.id = id;
