...
<title>记忆</title>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/memory.css">
<style>
body {
	...
	_background:#fff url(${CONTEXTPATH }/resources/netlib/images/bg01.jpg) no-repeat;
...
.impress-supported .bg {
	...
	left: 0;
	z-index: -100;
	background:#fff url(${CONTEXTPATH }/resources/netlib/images/bg04.jpg) no-repeat;
...
<div class="bg"><img src="${CONTEXTPATH }/resources/netlib/images/bg04.jpg" width="100%" /></div>

<header class="top" id="top">
	<h1><a href="http://www.lanrenzhijia.com/"><img src="${CONTEXTPATH }/resources/netlib/images/160_os_logo.png" alt="17素材"/></a><em>${year}大记事</em></h1>
	...
	<div id="impress">
		<div id="timeList">
			<div class="step year" data-x="-600" data-y="0" data-scale ="0.5" id="0">
				...
				<div class="list_show">${year}年<br/></div>
			</div>
			<c:forEach var="entity" items="${list}">
				<div class="timeList_item step" data-x="${entity.data_x}" data-y="0" id="${entity.tag}">
					<div class="circle">${entity.time }</div>
					<h2 class="timeList_item_title">${entity.item_title1}</h2>
					<div class="list_show">
						<img src="${CONTEXTPATH }${entity.show_img1}" width="500">
						<h2><a href="#">${entity.item_title1}</a></h2>
						<c:choose>
							<c:when test="${empty entity.show_img1}">
								<p class="m160">${entity.show_p}</p>
							</c:when>
							<c:otherwise>
								<p class="m160"><img src="${CONTEXTPATH }${entity.show_img2}" /></p>
							</c:otherwise>
						</c:choose>
					</div>
				</div>
			...
			<div class="timeList_item step refresh" data-x="5000" data-y="0" id="25">
				<div class="list_show">
					<a href='javascript:replay();'><img src="${CONTEXTPATH }/resources/netlib/images/refress.png"/></a>
					<p class="end">哈哈哈哈！${year}，我们会更加努力！</p>
				</div>
			</div>
		</div>
	</div>
</section>
<div class="gotop"> <a href="#top"><img src="${CONTEXTPATH }/resources/netlib/images/top.png" title="回顶部"/></a></div>

<script type="text/javascript" src="${CONTEXTPATH }/resources/netlib/js/impress.js"></script>
...
//预加载图片
new Image().src = "${CONTEXTPATH }/resources/netlib/images/bg04.jpg";
new Image().src = "${CONTEXTPATH }/resources/netlib/images/bg01.jpg";
new Image().src = "${CONTEXTPATH }/resources/netlib/images/bg02.jpg";
new Image().src = "${CONTEXTPATH }/resources/netlib/images/bg03.jpg";
...
$(function(){			
	...
	if(!$.browser.msie){
		if($.browser.safari)
			bgMusic = new Audio('${CONTEXTPATH }/resources/netlib/music/music.mp3');
		else
			bgMusic = new Audio('${CONTEXTPATH }/resources/netlib/music/music.mp3');
		bgMusic.loop = true;
		bgMusic.volume = 0.7;
...
var changeBackground = function(month){
	...
	if(month == 12 || month == 1 || month==2){
		if(last_month==4)
			return;
		last_month = 4;
		url = "${CONTEXTPATH }/resources/netlib/images/bg04.jpg";
		...
		if(last_month==1)
			return;
		last_month = 1;
		url = "${CONTEXTPATH }/resources/netlib/images/bg01.jpg";
		$("header").css("background-color","rgba(255,255,255,0.2)");
		...
		if(last_month==2)
			return;
		last_month = 2;
		url = "${CONTEXTPATH }/resources/netlib/images/bg02.jpg";
		...
		if(last_month==3)
			return;
		last_month = 3;
		url = "${CONTEXTPATH }/resources/netlib/images/xnback.jpg";
		$("header").css("background-color","rgba(255,255,255,0.2)");
