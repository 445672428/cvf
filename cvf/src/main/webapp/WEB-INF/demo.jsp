...
<script type="text/javascript" charset="utf-8" src="${CONTEXTPATH }/resources/netlib/js/CSSPlugin.min.js"></script>
<script type="text/javascript" charset="utf-8" src="${CONTEXTPATH }/resources/netlib/js/EasePack.min.js"></script>
<script type="text/javascript" charset="utf-8" src="${CONTEXTPATH }/resources/netlib/js/TweenLite.min.js"></script>
<style>
html, body {
  width: 100%;
  height: 100%;
...
<p id="offscreen-text" class="offscreen-text" style="font-size: 100px;"></p>
<p id="text" class="text" style="font-size: 100px; height: 100px; line-height: 100px;"></p>
